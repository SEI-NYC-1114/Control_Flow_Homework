...
var someNumber= Math.floor(Math.random()* 99) + 1
console.log(someNumber);
function prompt8(){ 
  if (someNumber< 30){
    console.log("Thats a small number!") 
  } else if (someNumber >= 30 && someNumber <= 60){
    console.log("That number is medium size.")
  } else { (someNumber >60)
...
function prompt9() {
  const starWars=["Han", "C3PO", "R2D2", "Luke", "Leia", "Anakin"];
    /*for(let i = 0' i < starWars.length; i++) {
      ...
      for (const [index, value] of ["Han", "C3PO", "R2D2", "Luke", "Leia", "Anakin"].entries()){
...
//   return arr[middle]
// }else {
//   const average = (arr[middle] + ar[middle -1]) /2;
//   return average
// }
