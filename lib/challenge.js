...
function prompt2() {
  // YOUR CODE HERE
  //iterate counting by two up to the number 100.  Console log each iteration.
...
function prompt10() {
  ...
  // YOUR CODE HERE
  for (let i = 0; i < 100; i++) {
    //if statement finds remainder at zero to push even number, and omits zero since it must be between 0 and 100.
    if (i % 2 === 0 && i !== 0) {
      myArray.push(i);
    }
  }
...
function prompt11() {
  ...
  // YOUR CODE HERE
  nums.sort();
  // console.log(nums); //checking numbers sorted correctly.
